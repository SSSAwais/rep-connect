...
const AddBilling = () => {
  ...
  const hanldesubmit = (e) => {
    ...
    if (
      ...
      billingForm.countryregion &&
      billingForm.towncity &&
      billingForm.streetaddres &&
      billingForm.state &&
      billingForm.zipcode
    ) {
      ...
      <form onSubmit={hanldesubmit}>
        ...
        <div className="form-row">
          ...
          <select
            ...
            value={billingForm.countryregion}
            onChange={hanldeChanged}
          >
        ...
        <div className="form-row">
          ...
          <input
            ...
            value={billingForm.streetaddres}
            onChange={hanldeChanged}
          />
        </div>
        <div className="form-row">
